...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        self.pushButton_12.setStyleSheet("QPushButton{\n"
                                         ...
                                         "}")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/whiteIcons/featherwhite/external-link.svg"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        ...
        self.pushButton_11.clicked.connect(self.RunQuery)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_12.setText(_translate("MainWindow", "Popout"))
        self.pushButton_13.setText(_translate("MainWindow", "Export"))
        __sortingEnabled = self.listWidget.isSortingEnabled()
        self.listWidget.setSortingEnabled(False)
        # item = self.listWidget.item(0)
        # item.setText(_translate("MainWindow", "Tab 1"))
        # item = self.listWidget.item(1)
        # item.setText(_translate("MainWindow", "Tab 2"))
        self.listWidget.setSortingEnabled(__sortingEnabled)
    ...
    def openloginwindow(self):
        ...
        self.lg.pushButton.clicked.connect(self.connectdb)
    ...
    def RunQuery(self):
        global con, ResultTabCounter, DataframeList

        QueryText = self.textEdit.toPlainText()

        self.label.setText("""Running Query!""")
        try:
